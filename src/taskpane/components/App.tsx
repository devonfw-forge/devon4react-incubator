                 ...
                 clickListener = async () => {
                   await Excel.run(async context => {
                     ...
                     activeSheet.onSelectionChanged.add(
                       this.click
                     ); // Check if the selected cell has changed
                     await context.sync();
                   });
                 };
                   ...
                   try {
                     return Excel.run(async context => {
                       ...
                       if (
                         ...
                         employeeData.data.value.length
                       ) {
                         this.setError(
                           true,
                           ERRORS.MORE_VALUES,
                       ...
                       this.setState({
                         ...
                         employeeName:
                           employeeData.activeEmployee, // Set the state name with the selected Employee
                         employeeCell:
                           employeeData.data.employeeCell, // Set the state name with the selected Employee
